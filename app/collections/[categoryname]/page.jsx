    ...
    useEffect(() => {
      dispatch(
        getCategoryProducts({
          ...
          page: productsBtnsNumber,
        })
      );
    }, [params?.categoryname, productsBtnsNumber]);
  ...
  return (
    <div className="mt-[12em] w-full flex flex-col mb-[2em]">
      <HeadingPart
        ...
        headerName={
          categoryDataProducts?.categoryData?.category_description?.name
        }
      />
      <div className="w-full mt-[3em] flex gap-[3em] px-3 py-2">
        ...
        <Cards
          typeGrid={typeGrid}
          products={categoryDataProducts && categoryDataProducts}
        />
      </div>
      <Pagination
        productsBtnsNumber={productsBtnsNumber && productsBtnsNumber}
      />
